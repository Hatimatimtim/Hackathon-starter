      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3.5">
        ...
        <Link href="/" className="flex items-center gap-2.5 group">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] text-slate-400 tracking-wide font-medium">Knowledge & Compliance</span>
          </div>
        </Link>

        {/* Navigation links */}
        <div className="flex items-center gap-1.5 text-sm bg-slate-900/60 p-1.5 rounded-xl border border-slate-800/60">
          {navLinks.map((link) => {
        ...
        <div className="hidden md:flex items-center gap-3">
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-900 border border-slate-800 text-xs">
            ...
            <span className="text-slate-300 font-medium flex items-center gap-1">
              <Bot className="h-3.5 w-3.5 text-cyan-400" /> AI Online
            </span>
          </div>

          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-cyan-950/40 border border-cyan-800/50 text-xs font-semibold text-cyan-300">
